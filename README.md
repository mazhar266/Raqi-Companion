...
- **Back up your lists** — export them to a JSON file and restore them later or on another device, from **Settings**. The file holds only the references, so it is a couple of kilobytes and keeps working after the app's data is updated.
