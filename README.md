...
- **Eight Quranic typefaces, and a size slider** — pick a font in Settings, previewed in the font itself, and scale the Arabic from 80% to 200%. Both apply to the Arabic only; the rest of the interface is unchanged.
